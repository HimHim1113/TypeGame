var QUESTION = ['kikai', 'denki', 'seigyo', 'kagaku', 'mazai', 'ryuunen', 'tanni', 'repo-to', 'puroguramingu', 'bibunsekibun', 'kosain', 'daio-do'];
var JAPANESE = ['機械', '電気', '制御', '化学', '魔剤', '留年', '単位', 'レポート', 'プログラミング', '微分積分', 'コサイン', 'ダイオード', 'NIT2.0'];
var counter = 0;
var endFlag = false;
